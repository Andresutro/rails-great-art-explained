...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference("Art.count") do
      post arts_url, params: { art: { category: @art.category, description: @art.description, title: @art.title, user_id: @art.user_id, year: @art.year } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { category: @art.category, description: @art.description, title: @art.title, user_id: @art.user_id, year: @art.year } }
